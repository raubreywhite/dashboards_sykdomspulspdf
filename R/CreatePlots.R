...
CreatePlots1 <- function(d, weeknow, Ukenummer, title, yrange) {
  ...
  plot(c(d[2, 30:52], d[2, 1:29]),
    ...
    main = "", xlab = "", ylab = "",
    lwd = 1.5, cex.lab = 0.75, cex.main = 2, axes = F
  ) # , dev.new(width=18, height=14))
  ...
  q <- legend("topright",
    inset = .02, roundUpNice(yrange), legend = c("2013 / 2014", "2014 / 2015", "2015 / 2016", "2016 / 2017", "2017 / 2018", "2018 / 2019"),
